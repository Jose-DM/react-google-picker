...
var GoogleChooser = function (_React$Component) {
  ...
  _createClass(GoogleChooser, [{
    ...
    value: function createPicker(oauthToken) {
      var DocsUploadView = new window.google.picker.DocsUploadView();
      DocsUploadView.setParent("root");
      ...
      var picker = new window.google.picker.PickerBuilder().addView(view).addView(DocsUploadView).setOAuthToken(oauthToken).setDeveloperKey(this.props.developerKey).setCallback(this.props.onChange);
